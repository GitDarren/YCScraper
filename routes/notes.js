...
//get route to return a single note for viewing
...
router.post('/createNote', function (req, res) {
    ...
    db.Note
        ...
        .then(result => {
            db.Article
                .findOneandUpdate({ _id: articleId }, { $push: { notes: result.id } }, { new: true })//saving reference to note in corresponding article
